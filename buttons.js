...
! function() {
    ...
    var e = window.document,
        ...
        C = function(e, o) {
            e = p(e).replace(/^octicon-/, ""), f(y, e) || (e = "mark-github");
        ...
        M = function(e, o) {
            ...
            if(!(t.push(o) > 1)) {
                var r = u((function() {
                    for(delete F[e]; o = t.shift();) o.apply(null, arguments)
                }));
                if(c) {
                    var n = new a;
                    ...
                    m(l, "load", d), m(l, "error", d), k(l, /de|m/, d), i.document.getElementsByTagName("head")[0].appendChild(l)
                }
            }
        },
        A = function(e, o, t) {
            ...
            if(((s === l || s === "gist." + l) && "archive" === h[3] || s === l && "releases" === h[3] && ("download" === h[4] || "latest" === h[4] && "download" === h[5]) || s === "codeload." + l) && (c.target = "_top"), "true" === p(o["data-show-count"]) && s === l && "marketplace" !== h[1] && "sponsors" !== h[1] && "orgs" !== h[1] && "users" !== h[1] && "-" !== h[1]) {
                var u, m;
                if(!h[2] && h[1]) m = "followers", u = "?tab=followers";
                else if(!h[3] && h[2]) m = "stargazers_count", u = "/stargazers";
                else if(h[4] || "subscription" !== h[3])
                    if(h[4] || "fork" !== h[3]) {
                        if("issues" !== h[3]) return void t(d);
                        m = "open_issues_count", u = "/issues"
                    } else m = "forks_count", u = "/network/members";
                else m = "subscribers_count", u = "/watchers";
                var v = h[2] ? "/repos/" + h[1] + "/" + h[2] : "/users/" + h[1];
                M.call(this, "https://api.github.com" + v, (function(e, o) {
                    if(!e) {
                        var a = o[m];
                        d.appendChild(r("a", {
            ...
            if(null != o && null != r)
                if(o.getAttribute && (o = function(e) {
                    ...
                    var l = function() {
                        ...
                        v(n, "load", l), A.call(c, a, o, (function(e) {
                            var a = function(e) {
                                var o = e.offsetWidth,
                                    r = e.offsetHeight;
                                if(e.getBoundingClientRect) {
                                    var a = e.getBoundingClientRect();
                                    o = t.max(o, G(a.width)), r = t.max(r, G(a.height))
                                }
                                return [o, r]
                            }(e);
                    ...
                    m(n, "load", l), e.body.appendChild(n)
                }
        };
    o.protocol + "//" + o.host + o.pathname === i ? A(e.body, b(window.name || o.hash.replace(/^#/, "")), (function() {})) : function(o) {
